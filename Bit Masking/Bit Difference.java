...
class Solution{
    ...
    public static int countBitsFlip(int a, int b)
    {
        ...
        int a_xor_b = a^b; //perform xor operation both the numbers..
        
        //count the number of setbits in a_xor_b..using Kernighans Algorithm.
        int count=0;
        while(a_xor_b!=0)
        {
            int rsbm = a_xor_b & -a_xor_b;  //rightmost set bit mask..
            a_xor_b = a_xor_b-rsbm;
            count++;
        }
        return count;
    }
